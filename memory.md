...
- The browser editor targets NexusEngine commit `100af375f31b13d3c8c16c633ede6e76f465672f`, loads the root and Composition semantic module separately, and resolves executable factories only through canonical package exports. A failed immutable import does not grant a project registry executable trust.
...
- The Engine dependency is pinned to commit `100af375f31b13d3c8c16c633ede6e76f465672f`; `package.json` also records registry and packed-artifact hashes. Validation uses the exact installed tarball, never a sibling source import or symlink.

...
- The browser editor targets NexusEngine commit `58fa721db73992d77d6866b282494a559f0ec13c`, loads the root and Composition semantic module separately, and resolves executable factories only through canonical package exports. A failed immutable import does not grant a project registry executable trust.
...
- The Engine dependency is pinned to commit `58fa721db73992d77d6866b282494a559f0ec13c`; `package.json` also records registry and packed-artifact hashes. Validation uses the exact installed tarball, never a sibling source import or symlink.

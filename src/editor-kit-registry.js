...
export const NEXUS_REALTIME_KIT_MANIFESTS = Object.freeze([
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/kit-manifest-domain-kit",
  ...
  },
  {
    ...
    type: "control-domain-service-kit",
    path: "@luminarylabs/nexusrealtime-protokits/capability-graph-domain-kit",
  ...
  },
  {
    ...
    type: "control-domain-service-kit",
    path: "@luminarylabs/nexusrealtime-protokits/composition-planning-domain-kit",
  ...
  },
  {
    ...
    type: "deploy-kit",
    path: "@luminarylabs/nexusrealtime-protokits/deploy-manifest-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/spatial-authoring-kits",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/spatial-scene-graph-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/selection-domain-service-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/transform-domain-service-kit",
    requires: ["scene:graph"],
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/widget-domain-service-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/interaction-domain-service-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/persistence-domain-service-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/render-descriptor-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/stereoscopic-render-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/audio-feedback-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/generic-input-actions-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/world-zone-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/terrain-height-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/route-clearance-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/vegetation-placement-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/damage-health-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/mana-meter-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/status-effect-domain-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/generic-defense-session-command-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/generic-route-cargo-extraction-kit",
  ...
  },
  {
    ...
    path: "@luminarylabs/nexusrealtime-protokits/banded-infinite-terrain-kit",
  ...
  },
  {
    ...
    type: "composite-domain-service-kit",
    path: "@luminarylabs/nexusrealtime-protokits/aerial-flight-kits",
...
export function createEditorKitInstallSurface(manifests = NEXUS_REALTIME_KIT_MANIFESTS) {
